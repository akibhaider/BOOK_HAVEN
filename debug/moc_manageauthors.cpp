...
#include "../../../../../../Bookhaven/BOOKHAVEN/BOOK_HAVEN/BookHaven_(Library+Bookshop)/manageauthors.h"
...
struct qt_meta_stringdata_CLASSManageAuthorsENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSManageAuthorsENDCLASS = QtMocHelpers::stringData(
    "ManageAuthors",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSManageAuthorsENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSManageAuthorsENDCLASS_t qt_meta_stringdata_CLASSManageAuthorsENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSManageAuthorsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ManageAuthors::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSManageAuthorsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSManageAuthorsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSManageAuthorsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ManageAuthors::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSManageAuthorsENDCLASS.stringdata0))
